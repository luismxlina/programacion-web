<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="es.uco.pw.business.inscripcion.models.factory.*" %>
...
<body>
  ...
  <jsp:include page="/include/header.jsp"></jsp:include>
	...
	%>
		<form id="formulario1" method="get" action="/sigma-camp/modifyReserve">
	...
	<%}else{
		...
		<form id="formulario2" method="get" action="/sigma-camp/modifyReserve">
		<label>Pista</label>
