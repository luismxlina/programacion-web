...
import business.campamento.handler.GestorCampamentos;
import business.campamento.models.campamento.Campamento;
import business.campamento.models.actividad.NivelEducativo;

/**
 * La clase MainCampamentos proporciona un menú de opciones relacionadas con la
...
public class MainCampamentos {
    ...
    public static void mostrarMenuCampamentos(Scanner teclado, GestorCampamentos gestor_campamentos) throws Exception {
    ...
    /**
     * Genera un ID único para un campamento utilizando un conjunto HashSet para
     * evitar duplicados.
     *
    ...
    /**
     * Solicita datos al usuario a través del teclado para crear un nuevo
     * Campamento.
     *
     * @param teclado         Scanner para la entrada de datos desde el teclado.
     * @param nuevoCampamento Objeto Campamento que se actualizará con los datos
     *                        ingresados.
    ...
    public static Campamento pedirDatosTeclado(Scanner teclado, Campamento nuevoCampamento) {
        ...
        nuevoCampamento.setMaxAsistentes(max_asistentes);
