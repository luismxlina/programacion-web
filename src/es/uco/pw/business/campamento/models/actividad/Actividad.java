...
public class Actividad implements Serializable {
     ...
     */
	public Actividad(String nombre, NivelEducativo nivel, LocalTime hora, int max_participantes, int num_monitores) {
	...
	public Actividad(ActividadDTO actividad) {
		...
		this.max_participantes = actividad.getMaxParticipantes();
		this.num_monitores = actividad.getNumMonitores();
		this.monitores = new ArrayList<Monitor>();
	}
