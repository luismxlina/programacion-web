...
/**
 * Esta clase implementa la interfaz DAOInscripcion y proporciona métodos para realizar operaciones CRUD
...
public class InscripcionDAO implements DAOInscripcion<InscripcionDTO, Integer> {
     ...
     *
     * @return Una lista de objetos InscripcionDTO que representan inscripciones completas.
     */
     ...
     *
     * @return Una lista de objetos InscripcionDTO que representan inscripciones parciales.
     */
     ...
     *
     * @param campamentoId El identificador del campamento.
     * @return Una lista de objetos InscripcionDTO que representan las inscripciones asociadas al campamento.
     */
