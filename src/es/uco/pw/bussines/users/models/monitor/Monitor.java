package es.uco.pw.bussines.users.models.monitor;
...
public class Monitor implements Serializable {
	...
	private Boolean esEducador;
	 ...
	 /**
     * Constructor parametrizado que inicializa un objeto Monitor con información completa.
     *
	...
	public Monitor() {
	 ...
	 /**
     * Constructor que inicializa un objeto Monitor con el identificador proporcionado.
     *
     * @param id Identificador único del monitor.
     */
