...
public class MainEditarCampamento {
    ...
    public static void mostrarMenuEditarCampamento(Scanner teclado, GestorCampamentos gestor_campamentos,
        ...
        ArrayList<Integer> ids = GestorCampamentos.getInstance().getAllIds();
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    gestor_campamentos.borrarActividad(nombreActividad, idCampamento);
                    break;
                case 3:
                    ...
                    gestor_campamentos.addMonitor(monitor, idCampamento);
                    System.out.println(nombreActividad);
                    gestor_campamentos.asociarMonitorActividad(monitor.getIdentificador(), nombreActividad, campamento.getIdentificador());
                    break;
                case 4:
    ...
    public static int generarIDUnico() {
         ...
         * @param nuevoMonitor Objeto Monitor que se actualizará con los datos ingresados.
         ...
         * @return El nombre o apellidos si la validación es exitosa, o una cadena vacía si hay un error.
         */
